...
trade_list =['JKPAPER','INGERRAND','VENKEYS','SCHNEIDER','RAYMOND','ASHOKA','DISHTV','HUHTAMAKI','BALMLAWRIE','SHOPERSTOP','HSCL','HAL','MAHSEAMLES','JTEKTINDIA','GRSE','RCF','GEPIL','IEX','TATAMOTORS','VEDL','FCONSUMER','BLISSGVS','SCI','ACC','SAIL','CUB','MRF','STAR','PFC','KEC','SFL','NCC','TCS','KSB','IOB','RAIN','BSE','NH','ITI','LTI','IGL','SIS','HEG','BDL','PVR','MGL','KEI','EPL','BEL','UPL','MMTC','IDEA','LT']
