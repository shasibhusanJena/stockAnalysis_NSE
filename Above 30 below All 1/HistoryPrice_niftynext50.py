...
def process_trade(trade_list):
    with open('niftynext50.txt', 'w') as f:
        ...
        # Large Cap
trade_list = ['ATGL','ADANITRANS','ADANIGREEN','GAIL','SHREECEM','GODREJCP','TORNTPHARM','INDIGO','COLPAL','NYKAA','HAVELLS','MARICO','DABUR','SIEMENS','IOC','PIDILITIND','MCDOWELL-N','MOTHERSON','DMART','MUTHOOTFIN','BIOCON','PIIND','BERGEPAINT','SRF','HAL','ZOMATO','IRCTC','LICI','PGHH','BEL','TATAPOWER','INDUSTOWER','ICICIPRULI','ACC','ICICIGI','BANDHANBNK','BOSCHLTD','HDFCAMC','NAUKRI','AMBUJACEM','PAYTM','CHOLAFIN','SBICARD','DLF','VEDL','LTIM','BANKBARODA','BAJAJHLDNG','MPHASIS','GLAND']
