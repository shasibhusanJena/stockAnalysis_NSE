...
def process_trade(trade_list):
    with open('smallcap100.txt', 'w') as f:
        ...
        # Large Cap
trade_list = ['BLUESTARCO','PRINCEPIPE','ANURAS','GMMPFAUDLR','PGHL','MCX','DEEPAKFERT','IRB','ELGIEQUIP','GARFIBRES','EASEMYTRIP','COCHINSHIP','EIDPARRY','KPITTECH','JBCHEPHARM','RBA','AMARAJABAT','METROBRAND','360ONE','MASTEK','TEAMLEASE','EIHOTEL','NH','CCL','AEGISCHEM','SUVENPHAR','MHRIL','TEJASNET','JYOTHYLAB','GPPL','TIMKEN','GODREJAGRO','MAHLIFE','UTIAMC','GAEL','KNRCON','SUNTECK','CARBORUNIV','GALAXYSURF','WESTLIFE','VIPIND','SHOPERSTOP','TCI','HLEGLAS','MOIL','GOCOLORS','JUBLINGREA','SIS','JUBLPHARMA','QUESS','LXCHEM','INDIGOPNTS','AETHER','APOLLOTYRE','WOCKPHARMA','CAMS','FINEORG','CESC','TRIVENI','BSOFT','RADICO','CENTURYPLY','HOMEFIRST','FINCABLES','ROSSARI','NOCIL','BALAMINES','RTNINDIA','KEC','CAPLIPOINT','BEML','HEG','VIJAYA','EDELWEISS','EXIDEIND','JKPAPER','ABSLAMC','RENUKA','SFL','MAHABANK','MOTILALOFS','ALOKINDS','NUVOCO','MGL','MAHINDCIE','KRBL','RAYMOND','CYIENT','BRIGADE','BHARATRAS','GUJALKALI','GSFC','ORIENTELEC','TANLA','RAIN','BAJAJELEC','CENTRALBK','PRAJIND','POLYPLEX','JKLAKSHMI']
