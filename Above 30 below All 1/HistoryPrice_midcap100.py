...
def process_trade(trade_list):
    with open('midcap100.txt', 'w') as f:
        ...
        # Large Cap
trade_list = ['ECLERX','MRPL','SWANENERGY','OLECTRA','JBMA','POLYMED','PRSMJOHNSN','ROUTE','ENGINERSIN','LEMONTREE','DIXON','GREENPANEL','MEDPLUS','ZYDUSWELL','NBCC','POLICYBZR','ANGELONE','CERA','BALKRISIND','MAHLOG','PHOENIXLTD','SWSOLAR','AIAENG','RATNAMANI','ZYDUSLIFE','MAXHEALTH','KALPATPOWR','PNCINFRA','GLENMARK','NAM-INDIA','JSL','TTKPRESTIG','CDSL','APTUS','HINDPETRO','THYROCARE','IFBIND','INDIANB','MAPMYINDIA','GRINDWELL','NLCINDIA','KIMS','SYNGENE','BALRAMCHIN','VARROC','WELSPUNIND','BLUEDART','ASTERDM','GMRINFRA','CHALET','CEATLTD','DCMSHRIRAM','RELAXO','IRFC','TRITURBINE','SUPRAJIT','LUXIND','PAGEIND','CAMPUS','VGUARD','IEX','OFSS','CREDITACC','PETRONET','DEEPAKNTR','TRIDENT','EMAMILTD','RVNL','TRENT','NCC','CHOLAHLDNG','ATUL','WELCORP','STARHEALTH','CENTURYTEX','SUDARSCHEM','BLUESTARCO','THERMAX','PRINCEPIPE','ANURAS','SAIL','KANSAINER','GMMPFAUDLR','3MINDIA','PGHL','RAJESHEXPO','MCX','AUBANK','DEEPAKFERT','IRB','ELGIEQUIP','TORNTPOWER','MANYAVAR','GARFIBRES','MSUMI','VOLTAS','ASHOKLEY','EASEMYTRIP','UBL','FLUOROCHEM']
